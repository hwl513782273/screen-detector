...
#   COMPAT_VERSION   : CFBundleShortVersionString，默认 '6.49.2'
...
COMPAT_VERSION = os.environ.get("COMPAT_VERSION", "6.49.2")
...
app = BUNDLE(
    ...
    info_plist={
        ...
        "NSHumanReadableCopyright": "Copyright © 2026 banqiu. Released under the MIT License.",
